SELECT peg.statecd,
       ...
       sum((grm.tpamort_unadj * (CASE
                                     ...
                                     ELSE (0)
                                 END) * (CASE
                                             WHEN grm.component LIKE 'MORTALITY%' THEN (((tre_midpt.drybio_stem + tre_midpt.drybio_stem_bark) - (tre_midpt.drybio_bole + tre_midpt.drybio_bole_bark) - (tre_midpt.drybio_stump + tre_midpt.drybio_stump_bark) + tre_midpt.drybio_branch) / 2000)
                                             ELSE (0)
...
LEFT OUTER JOIN
  (SELECT tre_cn,
          ...
          subp_tpamort_unadj_sl_forest AS tpamort_unadj
