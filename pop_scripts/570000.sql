SELECT peg.statecd,
       peg.eval_grp,
       570000 attribute_nbr,
       sum((tree.tpa_unadj * coalesce(((1 - (bark_vol_pct / (100 + bark_vol_pct))) *wood_spgr_greenvol_drywt/((1 - (bark_vol_pct / (100 + bark_vol_pct))) *wood_spgr_greenvol_drywt +(bark_vol_pct / (100 + bark_vol_pct)) *bark_spgr_greenvol_drywt) *(1.0 + mc_pct_green_wood * .01)+(bark_vol_pct / (100 + bark_vol_pct)) *bark_spgr_greenvol_drywt/((1 - (bark_vol_pct / (100 + bark_vol_pct))) *wood_spgr_greenvol_drywt +(bark_vol_pct / (100 + bark_vol_pct)) *bark_spgr_greenvol_drywt) *(1.0 + mc_pct_green_bark * .01)) ,1.76) * CASE
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               ELSE CASE least(tree.dia, 5 - 0.001)
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        ELSE CASE least(tree.dia, coalesce(plot.macro_breakpoint_dia, 9999) - 0.001)
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             END
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    END
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           END * coalesce(((tree.drybio_stem + tree.drybio_stem_bark) - (tree.drybio_bole + tree.drybio_bole_bark) - (tree.drybio_stump + tree.drybio_stump_bark) + tree.drybio_branch) / 2000, 0)) * pop_stratum.expns) AS estimated_value
