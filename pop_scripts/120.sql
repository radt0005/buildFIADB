SELECT peg.statecd,
       peg.eval_grp,
       120 attribute_nbr,
       sum((coalesce(cond_dwm_calc.fwd_sm_volcf_adj, 0) + coalesce(cond_dwm_calc.fwd_md_volcf_adj, 0) + coalesce(cond_dwm_calc.fwd_lg_volcf_adj, 0)) * pop_stratum.expns) AS estimated_value
