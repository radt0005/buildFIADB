                                 ...
                                 END) * (CASE
                                             WHEN be.oneortwo = 2 THEN (CASE
                                                                            WHEN (grm.component = 'SURVIVOR'
                                                                                  ...
                                                                                  OR grm.component LIKE 'REVERSION%') THEN (tree.volbfnet *
                                                                                                                              (SELECT factor
                                                                                                                               FROM fs_fiadb.ref_intl_to_doyle_factor
                                                                                                                               WHERE (dia_2inch_class = CASE
                                                                                                                                                            WHEN grm.dia_end < 31 THEN ((trunc(grm.dia_end / 2 + .5)) * 2)
                                                                                                                                                            ELSE 30
                                                                                                                                                        END)
                                                                                                                                 AND (softwood = CASE
                                                                                                                                                     WHEN (tree.spgrpcd <= 24
                                                                                                                                                           OR tree.spgrpcd IN (51, 52, 56)) THEN 'Y'
                                                                                                                                                     ELSE 'N'
                                                                                                                                                 END))/ plot.remper)
                                                                            WHEN (grm.component LIKE 'CUT%'
                                                                                  OR grm.component LIKE 'DIVERSION%') THEN (tre_midpt.volbfnet *
                                                                                                                              (SELECT factor
                                                                                                                               FROM fs_fiadb.ref_intl_to_doyle_factor
                                                                                                                               WHERE (dia_2inch_class = CASE
                                                                                                                                                            WHEN grm.dia_midpt < 31 THEN ((trunc(grm.dia_midpt / 2 + .5)) * 2)
                                                                                                                                                            ELSE 30
                                                                                                                                                        END)
                                                                                                                                 AND (softwood = CASE
                                                                                                                                                     WHEN (tree.spgrpcd <= 24
                                             ...
                                             ELSE (CASE
                                                       WHEN (grm.component = 'SURVIVOR'
                                                             ...
                                                             OR grm.component = 'MORTALITY1') THEN CASE
                                                                                                       WHEN tre_begin.tre_cn IS NOT NULL THEN - (tre_begin.volbfnet *
                                                                                                                                                   (SELECT factor
                                                                                                                                                    FROM fs_fiadb.ref_intl_to_doyle_factor
                                                                                                                                                    WHERE (dia_2inch_class = CASE
                                                                                                                                                                                 WHEN grm.dia_begin < 31 THEN ((trunc(grm.dia_begin / 2 + .5)) * 2)
                                                                                                                                                                                 ELSE 30
                                                                                                                                                                             END)
                                                                                                                                                      AND (softwood = CASE
                                                                                                                                                                          WHEN (tree.spgrpcd <= 24
                                                                                                       ...
                                                                                                       ELSE - (ptree.volbfnet *
                                                                                                                 (SELECT factor
                                                                                                                  FROM fs_fiadb.ref_intl_to_doyle_factor
                                                                                                                  WHERE (dia_2inch_class = CASE
                                                                                                                                               WHEN ptree.dia < 31 THEN ((trunc(ptree.dia / 2 + .5)) * 2)
                                                                                                                                               ELSE 30
                                                                                                                                           END)
                                                                                                                    AND (softwood = CASE
                                                                                                                                        WHEN (tree.spgrpcd <= 24
