SELECT peg.statecd,
       peg.eval_grp,
       124 attribute_nbr,
       sum((coalesce(cond_dwm_calc.fwd_sm_drybio_adj / 2000, 0) + coalesce(cond_dwm_calc.fwd_md_drybio_adj / 2000, 0) + coalesce(cond_dwm_calc.fwd_lg_drybio_adj / 2000, 0) + coalesce(cond_dwm_calc.cwd_drybio_adj / 2000, 0) + coalesce(cond_dwm_calc.pile_drybio_adj / 2000, 0)) * pop_stratum.expns) AS estimated_value
