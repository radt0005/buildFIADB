SELECT peg.statecd,
       peg.eval_grp,
       122 attribute_nbr,
       sum((coalesce(cond_dwm_calc.fwd_sm_carbon_adj, 0) / 2000 + coalesce(cond_dwm_calc.fwd_md_carbon_adj, 0) / 2000 + coalesce(cond_dwm_calc.fwd_lg_carbon_adj, 0) / 2000) * pop_stratum.expns) AS estimated_value
