SELECT peg.statecd,
       ...
       sum((grm.tparemv_unadj * (CASE
                                     ...
                                     ELSE (0)
                                 END) * (CASE
                                             WHEN grm.component LIKE 'CUT%' THEN (((tre_midpt.drybio_stem + tre_midpt.drybio_stem_bark) - (tre_midpt.drybio_bole + tre_midpt.drybio_bole_bark) - (tre_midpt.drybio_stump + tre_midpt.drybio_stump_bark) + tre_midpt.drybio_branch) / 2000)
                                             ELSE (0)
