       ...
       sum((grm.tparemv_unadj * (CASE
                                 ...
                                 END) * (CASE
                                             WHEN (grm.component LIKE 'CUT%'
                                                   OR grm.component LIKE 'DIVERSION%') THEN (((tre_midpt.drybio_bole + tre_midpt.drybio_bole_bark) / 2000) - ((tre_midpt.drybio_sawlog + tre_midpt.drybio_sawlog_bark) / 2000))
                                             ELSE (0)
