                                 ...
                                 END) * (CASE
                                             WHEN be.oneortwo = 2 THEN (CASE
                                                                            ...
                                                                            WHEN (grm.component LIKE 'CUT%'
                                                                                  ...
                                                                                  OR grm.component LIKE 'MORTALITY%') THEN (((tre_midpt.drybio_stem + tre_midpt.drybio_stem_bark) - (tre_midpt.drybio_bole + tre_midpt.drybio_bole_bark) - (tre_midpt.drybio_stump + tre_midpt.drybio_stump_bark) + tre_midpt.drybio_branch) / 2000 / plot.remper)
                                                                            ELSE (0)
                                                                        END)
                                             ELSE (CASE
                                                       WHEN (grm.component = 'SURVIVOR'
...
LEFT OUTER JOIN
  (SELECT tre_cn,
          ...
          dia_midpt,
          dia_end,
          subp_component_sl_timber AS component,
          subp_subptyp_grm_sl_timber AS subptyp_grm,
          subp_tpagrow_unadj_sl_timber AS tpagrow_unadj
