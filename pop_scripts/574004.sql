                                 ...
                                 END) * (CASE
                                             WHEN be.oneortwo = 2 THEN (CASE
                                                                            ...
                                                                            WHEN (grm.component LIKE 'CUT%'
                                                                                  OR grm.component LIKE 'DIVERSION%') THEN ((tre_midpt.drybio_bole + tre_midpt.drybio_bole_bark) / 2000 / plot.remper - (tre_midpt.drybio_sawlog + tre_midpt.drybio_sawlog_bark) / 2000 / plot.remper)
                                                                            ELSE (0)
                                                                        END)
                                             ELSE (CASE
                                                       WHEN (grm.component = 'SURVIVOR'
