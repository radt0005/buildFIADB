SELECT peg.statecd,
       peg.eval_grp,
       557000 attribute_nbr,
       sum((tree.tpa_unadj * coalesce(((1 - (bark_vol_pct / (100.0 + bark_vol_pct))) *wood_spgr_greenvol_drywt/((1 - (bark_vol_pct / (100.0 + bark_vol_pct))) *wood_spgr_greenvol_drywt +(bark_vol_pct / (100.0 + bark_vol_pct)) *bark_spgr_greenvol_drywt) *(1.0 + mc_pct_green_wood * .01)+(bark_vol_pct / (100.0 + bark_vol_pct)) *bark_spgr_greenvol_drywt/((1 - (bark_vol_pct / (100.0 + bark_vol_pct))) *wood_spgr_greenvol_drywt +(bark_vol_pct / (100.0 + bark_vol_pct)) *bark_spgr_greenvol_drywt) *(1.0 + mc_pct_green_bark * .01)) ,1.76) * CASE
