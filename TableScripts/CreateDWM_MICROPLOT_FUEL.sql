...
create index DMF_NAT_I on FS_FIADB.DWM_MICROPLOT_FUEL (PLOT, COUNTYCD, STATECD, SUBP, INVYR);
alter table FS_FIADB.DWM_MICROPLOT_FUEL add constraint DMF_PK primary key (CN);
alter table FS_FIADB.DWM_MICROPLOT_FUEL add constraint DMF_UK unique (SUBP, PLT_CN);