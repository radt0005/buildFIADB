...
alter table FS_FIADB.SUBPLOT add constraint SBP_CND_FK foreign key (SUBPCOND, PLT_CN) references FS_FIADB.COND (CONDID, PLT_CN);
alter table FS_FIADB.SUBPLOT add constraint SBP_CND_FK3 foreign key (MACRCOND, PLT_CN) references FS_FIADB.COND (CONDID, PLT_CN);
alter table FS_FIADB.SUBPLOT add constraint SBP_CND_FK2 foreign key (MICRCOND, PLT_CN) references FS_FIADB.COND (CONDID, PLT_CN);
