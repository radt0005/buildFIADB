...
comment on column fs_fiadb.sitetree.sieqn_ref_cd_fvs
  is 'NA';
create index SIT_NAT_I on FS_FIADB.SITETREE (COUNTYCD, UNITCD, STATECD, INVYR, TREE, CONDID, PLOT);
...
alter table FS_FIADB.SITETREE add constraint SIT_UK unique (TREE, PLT_CN, CONDID);
