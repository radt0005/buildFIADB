...
comment on table FS_FIADB.EVALIDATOR_POP_EST
  is '6.1';
-- Add comments to the columns 
comment on column FS_FIADB.EVALIDATOR_POP_EST.attribute_nbr
  is 'Arbitrary unique number';
comment on column FS_FIADB.EVALIDATOR_POP_EST.attribute_descr
  is 'Estimation attribute e.g. Area of timberland';
comment on column FS_FIADB.EVALIDATOR_POP_EST.vba_sumfromwhere
  is 'SQL segment used by EVALIDator program';
comment on column FS_FIADB.EVALIDATOR_POP_EST.pea_surrogate
...
comment on column FS_FIADB.EVALIDATOR_POP_EST.condtreeseed
...
comment on column FS_FIADB.EVALIDATOR_POP_EST.sort_col
  is 'Sort order for the Attribute drop down list within the EVALIDator program';
comment on column FS_FIADB.EVALIDATOR_POP_EST.eval_typ
  is 'Evaluation type - used by JAVA program PopEstFIADB4';
comment on column FS_FIADB.EVALIDATOR_POP_EST.estimate_metadata
  is 'Metadata description of the estimate';
comment on column FS_FIADB.EVALIDATOR_POP_EST.created_by
  is 'Created by';
comment on column FS_FIADB.EVALIDATOR_POP_EST.created_date
  is 'Created date';
comment on column FS_FIADB.EVALIDATOR_POP_EST.created_in_instance
  is 'Created in instance';
comment on column FS_FIADB.EVALIDATOR_POP_EST.modified_by
  is 'Modified by';
comment on column FS_FIADB.EVALIDATOR_POP_EST.modified_date
  is 'Modified date';
comment on column FS_FIADB.EVALIDATOR_POP_EST.modified_in_instance
  is 'Modified in instance';
comment on column FS_FIADB.EVALIDATOR_POP_EST.land_basis
  is 'Land basis for estimate. Timberland or Forest land';
comment on column FS_FIADB.EVALIDATOR_POP_EST.estimate_grp_descr
  is 'Estimation group description';
comment on column FS_FIADB.EVALIDATOR_POP_EST.estimate
  is 'Base attribute that is being estimated.';
comment on column FS_FIADB.EVALIDATOR_POP_EST.estn_type
  is 'Estimation type of the tree. GS, AL, SL for growing stock, all live, sawlog';
comment on column FS_FIADB.EVALIDATOR_POP_EST.estn_tree_portion
  is 'If tree estimate, the portion of the tree being estimate for the attribute.';
comment on column FS_FIADB.EVALIDATOR_POP_EST.estn_attribute
...
comment on column FS_FIADB.EVALIDATOR_POP_EST.estn_units_attribute
  is 'Estimation units stored in the attribute column. CF, BF, LBS for cubic feet, board feet, and pounds';
comment on column FS_FIADB.EVALIDATOR_POP_EST.estn_units_display
  is 'Units displayed by EVALIDator for the estimate (cubic feet, board feet, short tons)';
comment on column FS_FIADB.EVALIDATOR_POP_EST.estimate_variant
...
comment on column FS_FIADB.EVALIDATOR_POP_EST.growth_acct
...
comment on column FS_FIADB.EVALIDATOR_POP_EST.active
  is 'Y/N to indicate if attribute record is active or retired';
comment on column FS_FIADB.EVALIDATOR_POP_EST.notes
  is 'Notes';
-- Create/Recreate primary, unique and foreign key constraints 
alter table FS_FIADB.EVALIDATOR_POP_EST
